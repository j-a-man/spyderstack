                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-2 group/input">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full px-3 h-14 bg-background/40 border border-foreground/10 text-foreground focus:border-primary focus:outline-none rounded-none appearance-none transition-all duration-300 focus:bg-foreground/5"
                    >
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div className="flex items-start gap-6 group cursor-default">
                    <div className="w-14 h-14 bg-muted/50 flex items-center justify-center border border-foreground/10 group-hover:border-primary/50 group-hover:bg-primary/10 transition-all duration-300">
                    ...
                    <div>
                      ...
                      <a href="mailto:support@spyderstack.com" className="text-xl text-foreground hover:text-primary transition-colors font-display font-bold tracking-wide block">
                        support@spyderstack.com
                      </a>
                  ...
                  <div className="flex items-start gap-6 group cursor-default">
                    ...
                    <div>
                      ...
                      <a href="tel:3476354739" className="text-xl text-foreground hover:text-primary transition-colors font-display font-bold tracking-wide block">
                        (347) 635-4739
                      </a>
                  ...
                  <div className="flex items-start gap-6 group cursor-default">
                    ...
                    <div>
                      ...
                      <div className="text-foreground font-bold font-display tracking-wide text-lg">
                        New York, NY
                      </div>
