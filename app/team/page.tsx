      ...
      <div className="container mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {founders.map((member, i) => (
            <div 
              key={i} 
              className="group relative bg-white/5 border border-white/10 overflow-hidden hover:border-primary/50 transition-all duration-500 hover:-translate-y-2"
            >
              {/* Image Container */}
              <div className="relative h-[400px] w-full overflow-hidden border-b border-white/10">
              ...
              <div className="p-8 relative">
                {/* Decorative Corner */}
                <div className="absolute top-0 right-0 w-8 h-8 border-l border-b border-white/10 bg-background/50 backdrop-blur-sm" />
...
function JoinCTA() {
  return (
    <section className="relative z-10 py-32 border-t border-white/10 bg-black text-center">
       <div className="container mx-auto max-w-4xl px-6">
          ...
          <Button variant="outline" className="h-14 px-10 text-lg rounded-none border-white/20 hover:bg-white hover:text-black uppercase tracking-widest font-bold transition-all">
