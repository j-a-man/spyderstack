        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
          ...
          <div className="md:col-span-5">
            <Link href="/" className="flex items-center gap-3 group mb-6">
              ...
              <span className="text-2xl font-bold tracking-tighter text-foreground uppercase font-display">
                SpyderStack
              </span>
            </Link>
          ...
          <div className="md:col-span-2 md:col-start-7">
            <h4 className="text-foreground font-display font-bold uppercase tracking-widest mb-6">Company</h4>
          ...
          <div className="md:col-span-2">
            <h4 className="text-foreground font-display font-bold uppercase tracking-widest mb-6">Industries</h4>
            <ul className="space-y-4">
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-8">
            {footerLinks.legal.map((link) => (
              <Link key={link.href} href={link.href} className="text-xs text-muted-foreground hover:text-foreground uppercase tracking-widest transition-colors">
                {link.label}
              </Link>
            ))}
          </div>
